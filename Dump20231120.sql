...
CREATE TABLE `flight` (
  ...
  CONSTRAINT `flight_ibfk_1` FOREIGN KEY (`plane_ID`) REFERENCES `plane` (`plane_ID`),
  CONSTRAINT `flight_ibfk_2` FOREIGN KEY (`departureAirport_ID`) REFERENCES `airport` (`airport_ID`),
  CONSTRAINT `flight_ibfk_3` FOREIGN KEY (`destinationAirport_ID`) REFERENCES `airport` (`airport_ID`),
  CONSTRAINT `flight_ibfk_4` FOREIGN KEY (`timezone_ID`) REFERENCES `timezone` (`timezone_ID`),
  CONSTRAINT `flight_ibfk_5` FOREIGN KEY (`arrivalTimeZone_ID`) REFERENCES `timezone` (`timezone_ID`),
  CONSTRAINT `flight_ibfk_6` FOREIGN KEY (`departureTimeZone_ID`) REFERENCES `timezone` (`timezone_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reservation` (
  ...
  KEY `seat_ID` (`seat_ID`),
  CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`account_ID`) REFERENCES `account` (`account_ID`),
...
-- Dump completed on 2023-11-20 21:39:04
